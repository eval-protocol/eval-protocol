...
description: Get help and connect with other Eval Protocol developers
---

# Community Support

Welcome to the Eval Protocol community! Get help, share knowledge, and connect with other developers building evaluation functions.
...
### Code of Conduct
We are committed to providing a welcoming and inclusive environment for all community members. Please read our [Code of Conduct](https://github.com/fireworks-ai/eval-protocol/blob/main/CODE_OF_CONDUCT.md).
...
### Development Help
- **Evaluation Function Design**: Discord `#evaluation-functions`
...
- **Sharing your evaluation functions** in the community examples repo
