...
SDK](https://github.com/eval-protocol/python-sdk), pytest wrapper, a collection
of popular benchmark implementations, and a suite of tools that provide a
...
agents using Model Context Protocol (MCP). EP ensures consistent patterns
for writing evals, storing traces, and saving results—enabling you to build
...
<Frame caption={<span><a href="/tutorial/reviewing-evals-ui">Log Viewer: Monitor your evaluation rollouts in real time.</a></span>}>
