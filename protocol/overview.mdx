...
description: Technical specification of the Reward Protocol
---

# Protocol Overview

The Reward Protocol defines a standardized interface for creating, deploying, and evaluating reward functions across different platforms and environments.

## Core Principles

### Standardization
- **Consistent API**: Uniform interface across all reward functions
...
Every reward function must include:
...
### Testing Framework
```python
from reward_protocol.testing import RewardFunctionTest

class TestMathAccuracy(RewardFunctionTest):
...
- **Implementation Guide**: Learn how to [create reward functions](/development/getting-started)
