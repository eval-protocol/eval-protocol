...
description: 'Deploy and scale evaluation functions on the Fireworks AI platform'
---

# Fireworks AI Integration

[Fireworks AI](https://fireworks.ai) provides a high-performance platform for deploying and scaling AI models and evaluation functions. Eval Protocol includes native integration with Fireworks AI, enabling seamless deployment of evaluation functions to production environments.

## Overview

The Fireworks AI integration provides:
- **One-click deployment** of evaluation functions to scalable infrastructure
...
Deploy a evaluation function with minimal configuration:
