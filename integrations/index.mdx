...
<CardGroup cols={2}>
  <Card
    ...
    href="/integrations/gepa-trainer"
  >
  ...
  <Card
    title="rLLM Trainer"
    icon="tornado"
    href="/integrations/rllm-trainer"
  >
    Use Eval Protocol environments for reinforcement learning with rLLM
  </Card>
  <Card
    title="TRL Trainer"
    icon="brain"
    href="/integrations/trl-trainer"
  >
    Connect environments to TRL for GRPO training
  </Card>
  <Card
    title="OpenAI RFT"
    href="/integrations/openai-rft-trainer"
  >
    Fine-tune OpenAI models using Eval Protocol data
  </Card>
</CardGroup>
...
1. Follow the adapter structure in [`eval_protocol/adapters/`](https://github.com/eval-protocol/python-sdk/tree/main/eval_protocol/adapters)
2. Implement the `get_evaluation_rows()` method
3. Add appropriate tests
4. Update the [`__init__.py`](https://github.com/eval-protocol/python-sdk/blob/main/eval_protocol/adapters/__init__.py) to conditionally import your adapter
