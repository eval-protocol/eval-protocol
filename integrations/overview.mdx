...
description: Connect Eval Protocol with your existing tools and workflows
---

# Integrations Overview

Eval Protocol is designed to integrate seamlessly with your existing ML/AI infrastructure. This page provides an overview of supported integrations and how they work together.
...
<CardGroup cols={2}>
  ...
  >
    Deploy and scale evaluation functions in the cloud with enterprise-grade infrastructure
  </Card>
  <Card
  ...
  >
    Use evaluation functions in RLHF training pipelines for model alignment
  </Card>
</CardGroup>
...
Use evaluation functions during model training:

```python
from eval_protocol import load_function
from transformers import Trainer

# Load your evaluation function
...
Use evaluation functions for model evaluation:
...
Use evaluation functions in production serving:
...
graph TB
    ...
    C --> E[Model Inference]
    D --> F[Evaluation Function A]
    D --> G[Evaluation Function B]
    D --> H[Evaluation Function C]
...
```python
from eval_protocol import ConfigManager
...
- Monitor evaluation function accuracy
