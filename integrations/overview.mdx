...
<CardGroup cols={2}>
  ...
  >
    Use reward functions in RLHF training pipelines
  </Card>
  <Card
  ...
  >
    Integrate with model training and evaluation workflows
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  >
    Deploy and scale reward functions in the cloud
  </Card>
  <Card
    title="OpenAI"
    icon="openai"
  ...
  >
    Use with OpenAI models and fine-tuning
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card
    title="Braintrust"
    icon="chart-line"
    href="/integrations/braintrust"
  >
    Connect with evaluation and monitoring workflows
  </Card>
  <Card
    title="Weights & Biases"
    icon="weight"
    href="/integrations/wandb"
  >
...
<CardGroup cols={2}>
  ...
  >
    Scale evaluation across distributed clusters
  </Card>
</CardGroup>
