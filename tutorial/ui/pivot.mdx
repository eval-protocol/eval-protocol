...
There are three default configurations to help you get started:
...
<Frame caption={<span>The default configurations to help you get started.</span>}>
![Default configurations](/assets/default-configs.png)
</Frame>
