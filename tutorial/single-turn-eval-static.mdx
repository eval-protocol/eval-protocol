---
title: Single-Turn Eval
description: 'Create your first static single-turn eval'
sidebarTitle: Single-Turn Eval
---
...
<Note>
You can find the complete code for this example at [test_markdown_highlighting.py](https://github.com/eval-protocol/python-sdk/blob/main/tests/pytest/test_markdown_highlighting.py).
</Note>
...
The evaluation function is the core logic that analyzes model responses. In the current implementation, this is done inline within the test function:
