---
title: Quick Start
description: 'Create your first evaluation function in minutes'
---

# Quick Start

Get started with Eval Protocol by creating your first evaluation function in just a few minutes.

## Create Your First Evaluation Function

Here's a simple example of an evaluation function that evaluates responses based on word count:
...
Deploy your evaluation function for use in production:
...
<CardGroup cols={2}>
  ...
  >
    Learn the fundamentals of evaluation functions
  </Card>
  <Card
    title="Examples"
    icon="code"
