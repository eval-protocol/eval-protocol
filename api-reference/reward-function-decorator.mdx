...
description: 'The core decorator for creating reward functions in Eval Protocol'
---

# @reward_function Decorator

The `@reward_function` decorator is the primary way to create reward functions in Eval Protocol. It transforms your evaluation logic into a standardized format that can be deployed across different platforms.
