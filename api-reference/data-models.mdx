---
title: 'Data Models'
description: 'Core data structures used in Eval Protocol'
---

# Data Models

Eval Protocol defines standardized data models to ensure consistency across all evaluation functions and platforms. These models use Pydantic for type validation and serialization.
...
```python
from eval_protocol.models import ToolCall, Function
...
Evaluation functions receive conversations as lists of dictionaries:
...
For full type safety in your evaluation functions:
...
- Learn how to use these models with the [@evaluation_function decorator](/api-reference/evaluation-function-decorator)
