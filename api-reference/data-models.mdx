...
Eval Protocol defines standardized data models to ensure consistency across all reward functions and platforms. These models use Pydantic for type validation and serialization.
