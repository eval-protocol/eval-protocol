...
Generation parameters for the rollout. Must include a `model` field using a LiteLLM-compatible provider route (e.g., `openai/gpt-4o`, `anthropic/claude-3-sonnet`, `fireworks_ai/*`). See the LiteLLM providers list for supported prefixes and models: https://docs.litellm.ai/docs/providers
</ParamField>
