...
description: Advanced guide for developing with Reward Protocol
---
...
from reward_protocol.types import EvaluationResult
import asyncio
...
### Multi-Modal Support
```python
from reward_protocol.types import MultiModalInput
...
from reward_protocol.cache import RewardCache
...
### Batch Processing
```python
from reward_protocol.batch import BatchProcessor
...
```python
import logging
from reward_protocol.exceptions import RewardProtocolError
...
```python
import time
from reward_protocol.monitoring import MetricsCollector
...
class TestAdvancedEvaluator(RewardFunctionTest):
    ...
    def test_score_range(self):
        ...
        test_cases = [
            ...
            ("Query with unicode 🚀", "Response with unicode ✨")
        ]
    ...
    def test_edge_cases(self):
        ...
        edge_cases = [
            ...
            ("Unicode: 你好世界", "Response: مرحبا بالعالم")
        ]
  ...
  template:
    ...
    spec:
      ...
      - name: reward-function
        ...
        - containerPort: 8000
        env:
        - name: REWARD_PROTOCOL_LOG_LEVEL
          value: "INFO"
        resources:
          requests:
            cpu: 100m
