...
description: 'Learn the fundamentals of evaluation functions and evaluation workflows'
---

# Getting Started with Evaluation Functions

This guide introduces the core concepts of Eval Protocol and walks you through creating your first evaluation function.

## What is a Evaluation Function?

A evaluation function is a Python function that evaluates the quality of AI model responses. It takes a conversation history and returns a score along with detailed metrics.
...
### 1. The `@evaluation_function` Decorator
...
All evaluation functions return an `EvaluateResult`:
...
### Step 1: Create Your First Evaluation Function
...
<CardGroup cols={2}>
  <Card
    title="Evaluation Function Anatomy"
    icon="microscope"
    href="/developer-guide/evaluation-function-anatomy"
  >
