...
description: 'Deep dive into the structure and components of evaluation functions'
---

# Evaluation Function Anatomy

Understanding the anatomy of a evaluation function is crucial for building effective evaluation systems. This guide breaks down every component and explains how they work together to create robust, scalable evaluation logic.

## Core Structure

Every evaluation function in Eval Protocol follows a consistent structure:
...
def run_self_tests():
    """Built-in self-tests for the evaluation function."""
    test_cases = [
        {
