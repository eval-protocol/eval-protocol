...
<Note>
Code lives in the Python SDK at examples/aime2025_chat_completion. See the test at [examples/aime2025_chat_completion/tests/test_aime2025.py](https://github.com/eval-protocol/python-sdk/blob/main/examples/aime2025_chat_completion/tests/test_aime2025.py).
</Note>
...
```bash
pytest -q examples/aime2025_chat_completion/tests/test_aime2025.py \
