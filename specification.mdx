...
- **Evaluation Criteria**: Success thresholds (via `passed_threshold`) and metrics
...
@evaluation_test(
    ...
    completion_params=[{"model": "accounts/fireworks/models/llama-v3p1-8b-instruct", "temperature": 0.0, "max_tokens": 4096}],
