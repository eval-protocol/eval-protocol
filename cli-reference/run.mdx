...
The `run` command is the primary tool for executing comprehensive evaluations using Reward Protocol. It leverages Hydra for configuration management, allowing you to define complex evaluation pipelines through YAML files.
