...
description: 'Command-line interface guide for Reward Protocol'
---

# CLI Reference Overview

The Reward Protocol CLI provides powerful commands for developing, testing, and deploying reward functions. All commands are available through the `reward-protocol` command.
...
<CardGroup cols={2}>
  ...
  >
    Deploy reward functions to production
  </Card>
  <Card
    title="help"
    icon="question"
...
```bash
# 1. Create and test reward function locally
...
3. **Module Import Error**
   ```bash
   Error: Cannot import reward function
   ```
