...
The math evaluation function extracts and compares numerical answers:
...
from eval_protocol.integrations.trl import TRLAdapter

# Convert dataset
convert_dataset_to_jsonl("gsm8k", "gsm8k_trl.jsonl")

# Create TRL adapter
adapter = TRLAdapter(evaluation_function=math_reward)
